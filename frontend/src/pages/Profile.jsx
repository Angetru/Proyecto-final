...
function Profile() {
  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      ...
      console.log(localStorage.getItem('userId')); // Verifica si el userId está disponible
  ...
  const handleSubmit = async (e) => {
    ...
    const token = localStorage.getItem('token');
    const userId = localStorage.getItem('userId'); // Asegúrate de tener este valor al iniciar sesión
