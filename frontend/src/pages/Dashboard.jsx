...
function Dashboard() {
  return (
    <div className="container mx-auto mt-20 p-4 bg-white rounded-lg shadow-md">
      ...
      <h2 className="text-lg font-semibold mb-4 text-center">Selecciona una opción, ya sea para acceder a farmacos, tratamientos para alertas y editar tu perfil</h2>
      ...
      <nav className="flex justify-center space-x-4 mb-6">
        ...
        <Link 
          to="profile" 
          className="text-white bg-blue-700 px-4 py-2 rounded-lg hover:bg-blue-600"
        >
          Perfil
        </Link>
      </nav>
