  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data && response.data.token && response.data.user) {
        ...
        console.log('Token y UserID almacenados:', localStorage.getItem('token'), localStorage.getItem('userId'));
        
        // Redirige al dashboard
        navigate('/dashboard');
      } else {
        // Si no hay token o userID, muestra un mensaje de error
        setErrorMessage('Error: No se recibió un token de autenticación o ID de usuario.');
        console.error('Error: No se recibió un token de autenticación o ID de usuario.');
      }
